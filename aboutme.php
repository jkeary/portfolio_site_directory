      ...
      <div class="container" style="max-width:1100px">
        ...
        <div>
          <p class="lead">
            ...
            <br><br>
            For the past 5 years I worked as a Software Engineer for the Washington D.C. political advocacy marketing start-up Crowdskout.  Here is my current <a href="./docs/SoftwareEngineerResume.pdf" align="right" target="_blank">software engineering resume</a> with details on what I accomplished in that field.
            <br><br>
            I also have work and education experience in the audio tech field.  I went to NYU Steinhart where I received my Masters in Music Technology.  Here is my current <a href="./docs/AudioEngineerResume.pdf" align="right" target="_blank">audio engineering resume</a> with my accomplishments in that line of work.
            <br><br>
