...
<body>
  <div id="wrap">
    ...
    <div class="container" style="max-width:950px">
      ...
      <a href="webaudioapi.php">
        <div class="projentry">
          <div id="imgwrapper">
            <img src="imgs/oscilloscope.png" class="img-responsive img-rounded" alt="Responsive image">
          </div>
          <div id="contentwrapper">
            <h2>Fun with Oscillators</h2>
            <p><a></a>Heres an oscillator I made using the <a href='https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API' target="_blank">web audio api</a></p>
          </div>
        </div>
      </a>   
