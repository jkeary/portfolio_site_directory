...
/**
 * EnvSinToTri_SynthNoteApplet.java
 * 
 * Play a SynthNote in an Applet using SoundTester
 * 
 */

public class EnvSintoTri_SynthNoteApplet extends java.applet.Applet {

	EnvSintoTri_SynthNote mySynthNote;
	LineOut myOut;
...
/* Make waveform unit generators. */
		mySynthNote = new EnvSintoTri_SynthNote();
		myOut = new LineOut();
