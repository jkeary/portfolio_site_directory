...
/**
 * MyEnvelopedSawTritoImpApplet.java
 * 
 * Play a SynthNote in an Applet using SoundTester
 * 
 */

public class MyEnvelopedSawTritoImpApplet extends java.applet.Applet {

	MyEnvelopedSawTritoImpSynthNote mySynthNote;
	LineOut myOut;
...
/* Make waveform unit generators. */
		mySynthNote = new MyEnvelopedSawTritoImpSynthNote();
		myOut = new LineOut();
