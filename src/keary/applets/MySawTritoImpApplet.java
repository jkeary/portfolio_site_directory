...
/**
 * MySawTritoImpApplet.java
 * 
 * Play a SynthNote in an Applet using SoundTester
 * 
 */

public class MySawTritoImpApplet extends java.applet.Applet 
{
	MySawTritoImpSynthNote mySynthNote;
	LineOut myOut;
...
/* Make waveform unit generators. */
		mySynthNote = new MySawTritoImpSynthNote();
		myOut = new LineOut();
...
/* Can be run as either an application or as an applet. */
    ...
    {
    	MySawTritoImpApplet applet = new MySawTritoImpApplet();
