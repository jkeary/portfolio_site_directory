...
/**
 * SqueeksENV_SynthNote_Applet.java
 * 
 * Play a SynthNote in an Applet using SoundTester
 * 
 */

public class SqueeksENV_SynthNote_Applet extends java.applet.Applet {

	SqueeksENV_SynthNote mySynthNote;
	LineOut myOut;
...
/* Make waveform unit generators. */
		mySynthNote = new SqueeksENV_SynthNote();
		myOut = new LineOut();
