...
/**
 * Squeeks_SynthNote_Applet.java
 * 
 * Play a SynthNote in an Applet using SoundTester
 * 
 */

public class Squeeks_SynthNote_Applet extends java.applet.Applet {

	Squeeks_SynthNote mySynthNote;
	LineOut myOut;
...
/* Make waveform unit generators. */
		mySynthNote = new Squeeks_SynthNote();
		myOut = new LineOut();
